...
<html lang="pt-br">
    <head>
        ...
        <title>JB-Commerce - Form Categoria</title>
                ...
                <input type="hidden" name="categoria.ativo" value="${categoria.isAtivo()}">
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            ...
                            <button type="submit" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#formcategoria">Salvar</button>
                        </div> 
                    </div>
                </form>
            </div>
