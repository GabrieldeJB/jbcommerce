...
<html lang="pt-br">
    <head>
        ...
        <title>JB-Commerce - Cadastrar</title>
                    ...
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            <div class="form-group input-login mx-auto">
                                <input name="usuario.nome" value= "${usuario.getNome()}" minlength="6" maxlength="100" class="form-control" id="email" type="text" placeholder="Nome *" required="required" data-validation-required-message="Please enter your email address." />
                            ...
                            <div class="form-group input-login mx-auto">
                                <input name="usuario.senha" value= "${usuario.getSenha()}" minlength="8" maxlength="30" class="form-control" id="phone" type="password" placeholder="Senha *" required="required" data-validation-required-message="Insira sua senha." />
                                <p class="help-block text-danger"></p>
                            </div>
                            
                             <div class="form-group input-login mx-auto">
                                <input name="confirmaSenha" value= "${confirmarSenha}" minlength="8" maxlength="30" class="form-control" id="phone" type="password" placeholder="Confirmar senha *" required="required" data-validation-required-message="Insira sua senha." />
                                <p class="help-block text-danger"></p>
                            </div>
